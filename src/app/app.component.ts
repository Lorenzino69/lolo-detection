...
export class AppComponent implements OnInit {
  ...
  public modelText: string = 'Selectionnez le modèle MobileNet';
  public modelLoaded: boolean = false;
  public title: string = 'LOLO Detection';
  public introline: string = '(TensorFlow.js et Coco-SSD Model)';
  ...
  public videoMode() {
    if (!this.webBtnStatus) {
      this.fileName = 'Pas de fichiers choisi';
      this.canvas = document.getElementById("canvas");
      this.canvasContext = this.canvas.getContext("2d");
      this.canvasContext.clearRect(0, 0, 400, 300);
      this.imageSrc = 'assets/white.jpg';
